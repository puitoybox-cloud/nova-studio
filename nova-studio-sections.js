...
(function(){
  ...
  if(typeof baseHomeView==='function')window.homeView=function(){const html=baseHomeView();return html.includes('class="atelier-home home-only"')?html:insertSections(html)};
