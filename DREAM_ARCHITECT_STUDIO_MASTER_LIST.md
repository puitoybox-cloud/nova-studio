...
| --- | --- | --- | --- | --- |
| 音楽・音声 | 音楽制作 | 優先制作 | あり | Music Studio（内部または設定URL） |
| 音楽・音声 | MIDI Composer | 優先制作 | あり | Music Studio（内部または設定URL） |
| 音楽・音声 | 歌詞・音符割付 | 既存アプリあり | あり | Music Studio（内部または設定URL） |
| 音楽・音声 | ボイス制作 | 未実装 | 予定 | URL未設定 |
| イラスト・漫画 | 画像制作 | 連携準備中 | 準備中 | URL未設定 |
| イラスト・漫画 | 漫画制作 | 未実装 | 予定 | URL未設定 |
| イラスト・漫画 | LINEスタンプ制作 | 未実装 | 予定 | URL未設定 |
| 映像・アニメ | AIアニメ制作 | 既存アプリあり | あり | Production Dashboard（内部または設定URL） |
| 映像・アニメ | Viduプロンプト作成 | 既存アプリあり | あり | Prompt Studio（内部または設定URL） |
| 映像・アニメ | 動画制作 | 連携準備中 | 準備中 | URL未設定 |
| 公開・管理 | ホームページ制作 | 未実装 | 予定 | URL未設定 |
| 公開・管理 | プロンプト管理 | 連携準備中 | 準備中 | URL未設定 |
| 公開・管理 | 今後追加する制作アプリ | 確認待ち | 接続仕様確認待ち | URL未設定 |
