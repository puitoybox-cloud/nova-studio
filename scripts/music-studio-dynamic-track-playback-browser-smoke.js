...
async function verifyViewport(browser,viewport){
  ...
  await page.close();
  return{viewport:viewport.width,labels,trackControls:6,externalMuteIsolation:true,multipleSolo:true,controlsOverlap:false,currentTrackId:'external-target',notes:12,buttonPlayback:true,shortcutPlayback:true,stop:true,externalRecordingPreserved:true,externalBatchEditingPreserved:true,externalLocalPartialEdit:true,externalProviderGate:true,horizontalOverflow:false,consoleErrors:0,consoleWarnings:0};
}
