...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.42/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.108/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.108/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.85/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.85/);
