...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.43/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.109/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.109/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.86/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.86/);
