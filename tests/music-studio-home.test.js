...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.19/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.74/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.74/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.57/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.57/);
