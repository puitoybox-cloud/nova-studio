...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.86/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.86/);
  ...
  assert.match(hostSource,/music-studio-audio\.js\?v=1\.4\.11/);assert.match(standaloneSource,/music-studio-audio\.js\?v=1\.4\.11/);
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.69/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.69/);
