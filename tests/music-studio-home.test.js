...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.34/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.34/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.44/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.44/);
