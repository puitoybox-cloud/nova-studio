...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.29/);
  ...
  assert.match(hostSource,/music-studio-editor\.js\?v=1\.4\.10/);assert.match(standaloneSource,/music-studio-editor\.js\?v=1\.4\.10/);
  assert.match(hostSource,/music-studio-audio\.js\?v=1\.4\.12/);assert.match(standaloneSource,/music-studio-audio\.js\?v=1\.4\.12/);
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.74/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.74/);
