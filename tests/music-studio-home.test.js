...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.53/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.125/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.125/);
  ...
  assert.match(hostSource,/music-studio-editor\.js\?v=1\.4\.15/);assert.match(standaloneSource,/music-studio-editor\.js\?v=1\.4\.15/);
  assert.match(hostSource,/music-studio-audio\.js\?v=1\.4\.13/);assert.match(standaloneSource,/music-studio-audio\.js\?v=1\.4\.13/);
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.97/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.97/);
  assert.match(hostSource,/MusicStudioEditor\?\.ASSET_VERSION==='1\.4\.15'&&typeof window\.MusicStudioEditor\.externalReviewTracks==='function'/);
  assert.match(hostSource,/MusicStudio\?\.ASSET_VERSION==='1\.4\.97'&&typeof window\.MusicStudio\.externalTrackReviewHtml==='function'/);
  assert.match(hostSource,/window\.MusicStudioRuntime=Object\.freeze\(\{hostLoader:'1\.5\.53',stylesheet:'1\.4\.125'/);
