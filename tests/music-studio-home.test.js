...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.15/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.73/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.73/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.53/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.53/);
