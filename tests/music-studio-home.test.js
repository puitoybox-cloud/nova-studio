...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.52/);
  ...
  assert.match(hostSource,/music-studio-editor\.js\?v=1\.4\.14/);assert.match(standaloneSource,/music-studio-editor\.js\?v=1\.4\.14/);
  assert.match(hostSource,/music-studio-audio\.js\?v=1\.4\.13/);assert.match(standaloneSource,/music-studio-audio\.js\?v=1\.4\.13/);
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.96/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.96/);
