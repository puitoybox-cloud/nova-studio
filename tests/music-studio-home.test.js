...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.4\.19/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.24/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.24/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.34/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.34/);
