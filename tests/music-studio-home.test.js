...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.33/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.92/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.92/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.77/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.77/);
