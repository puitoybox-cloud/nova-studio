...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(indexSource,/app\.js\?v=1\.5\.45/);
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.111/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.111/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.87/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.87/);
