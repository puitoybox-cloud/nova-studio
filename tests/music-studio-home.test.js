...
test('Music Studio dependencies load sequentially without querying detached scripts',()=>{
  ...
  assert.match(hostSource,/music-studio\.css\?v=1\.4\.117/);assert.match(standaloneSource,/music-studio\.css\?v=1\.4\.117/);
  ...
  assert.match(hostSource,/music-studio\.js\?v=1\.4\.91/);assert.match(standaloneSource,/music-studio\.js\?v=1\.4\.91/);
