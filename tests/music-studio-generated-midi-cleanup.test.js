...
test('cleanup reuses the Import Export popover layout without dedicated positioning',()=>{const source=fs.readFileSync(path.join(__dirname,'..','music-studio.js'),'utf8'),css=fs.readFileSync(path.join(__dirname,'..','music-studio.css'),'utf8');assert.match(source,/music-editor-popover music-editor-transfer music-cleanup-popover/);assert.doesNotMatch(css,/\.music-cleanup-popover\s*\{/);assert.match(css,/\.nova-unified-content:has\(>\.music-midi-editor-page\),\.nova-studio-route-content:has\(>\.music-midi-editor-page\)\{overflow:visible;-webkit-backdrop-filter:none;backdrop-filter:none\}/)});
