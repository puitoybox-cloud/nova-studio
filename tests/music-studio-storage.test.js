...
function richProject(app,id='storage-project'){
  const tracks=[
    ...
    {id:'melody',part:'melody',name:'Melody',channel:1,program:0,muted:false,trackMetadata:{instrument:'lead'},notes:[{id:'melody-1',pitch:60,startTick:0,durationTicks:480,velocity:80,noteMetadata:{lyric:'la'}},{id:'melody-2',pitch:67,startTick:960,durationTicks:240,velocity:104,noteMetadata:{lyric:'na'}}]},
  ...
  return app.makeProject({projectId:id,projectName:'Storage Regression',songTitle:'Three Tracks and Unknown',midiData:{version:1,ppq:960,tempo:137,timeSignature:{numerator:7,denominator:8},totalTick:184320,tracks,editor:{measureCount:96,loopEnabled:true,loopStart:1920,loopEnd:7680,view:{zoom:3,pitchMin:24,pitchMax:84,pitchScrollTop:240,pitchScrollLeft:360,snapEnabled:false,snap:'1/8',quantizeEnabled:true,quantize:'1/16'},transport:{countInEnabled:false,metronomeEnabled:true}}}})
}
