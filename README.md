...
Nova Studio は、作品・話数・Scene・制作アプリをひとつのホームから安全に開くための、創作制作環境の入口です。Version 0.2.5 では、Import Center・Production Dashboard・Prompt Studio・Music Studio・Universe が共通で利用する Story Archive の土台として、1作品 → 話数 → カテゴリ → カードの共通データ構造とCRUD画面を追加しました。

## Version 0.2.5で追加したこと

- Story Archive共通データ構造を追加しました。構造は「1作品 → 話数 → カテゴリ → カード」です。
- Story Archiveカードは、ID、タイトル、本文、カテゴリ、タグ、作品、話数、関連カード、作成日時、更新日時、状態を持ちます。
...
Story Archive画面では、1作品 → 話数 → カテゴリ → カードの共通構造でカードを一覧し、作成・編集・削除できます。ダミーデータを1件登録してCRUDの動作確認もできます。
